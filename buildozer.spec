...
# (str) Package name
package.name = sovereign_ai

# (str) Package domain (needed for android/ios packaging)
package.domain = org.samrat
...
requirements = python3,kivy==2.2.1,opencv-python,numpy,sqlite3,hostpython3
...
>>>>>>> 8e3378b (Sovereign AI initial setup)
